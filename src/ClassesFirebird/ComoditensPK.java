 ...
 * @author vplayer
 */
public class ComoditensPK implements Serializable {
    ...
    public ComoditensPK(String nrcontr, int nritem) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ComoditensPK)) {
            return false;
        }
        ComoditensPK other = (ComoditensPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.ComoditensPK[ nrcontr=" + nrcontr + ", nritem=" + nritem + " ]";
    }
