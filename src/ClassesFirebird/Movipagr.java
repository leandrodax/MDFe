...
public class Movipagr {
    ...
    private String nrcontrcc;

    public Movipagr() {
    }

    public Movipagr(Integer nrcont) {
        this.nrcont = nrcont;
    }
    ...
    public String getNrcontrcc() {
        return nrcontrcc;
    }

    public void setNrcontrcc(String nrcontrcc) {
        this.nrcontrcc = nrcontrcc;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Movipagr)) {
            return false;
        }
        Movipagr other = (Movipagr) object;
    ...
    public String toString() {
        return "ClassesFirebird.Movipagr[ nrcont=" + nrcont + " ]";
    }
