...
public class SaidaitensPK  {
    ...
    public SaidaitensPK(String nrcontr, int nritem) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SaidaitensPK)) {
            return false;
        }
        SaidaitensPK other = (SaidaitensPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.SaidaitensPK[ nrcontr=" + nrcontr + ", nritem=" + nritem + " ]";
    }
