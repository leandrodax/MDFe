...
public class Movientnfe implements Serializable {
    ...
    public Movientnfe(Integer keynfe) {
        this.keynfe = keynfe;
    }

    public Movientnfe(Integer keynfe, int codfil, String id) {
        this.keynfe = keynfe;
        this.codfil = codfil;
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Movientnfe)) {
            return false;
        }
        Movientnfe other = (Movientnfe) object;
    ...
    public String toString() {
        return "ClassesFirebird.Movientnfe[ keynfe=" + keynfe + " ]";
    }
