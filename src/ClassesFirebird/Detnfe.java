...
public class Detnfe {
    ...
    public Detnfe(DetnfePK detnfePK) {
        this.detnfePK = detnfePK;
    }

    public Detnfe(int keynfe, int nitem) {
        this.detnfePK = new DetnfePK(keynfe, nitem);
    }

    public DetnfePK getDetnfePK() {
        return detnfePK;
    }

    public void setDetnfePK(DetnfePK detnfePK) {
        this.detnfePK = detnfePK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (detnfePK != null ? detnfePK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Detnfe)) {
            return false;
        }
        Detnfe other = (Detnfe) object;
        if ((this.detnfePK == null && other.detnfePK != null) || (this.detnfePK != null && !this.detnfePK.equals(other.detnfePK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "ClassesFirebird.Detnfe[ detnfePK=" + detnfePK + " ]";
    }
