...
public class Movinegr {
    
    private static final long serialVersionUID = 1L;
    protected MovinegrPK movinegrPK;
    ...
    public Movinegr(MovinegrPK movinegrPK) {
        this.movinegrPK = movinegrPK;
    }

    public Movinegr(String codtit, String codcli) {
        this.movinegrPK = new MovinegrPK(codtit, codcli);
    }

    public MovinegrPK getMovinegrPK() {
        return movinegrPK;
    }

    public void setMovinegrPK(MovinegrPK movinegrPK) {
        this.movinegrPK = movinegrPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (movinegrPK != null ? movinegrPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Movinegr)) {
            return false;
        }
        Movinegr other = (Movinegr) object;
        if ((this.movinegrPK == null && other.movinegrPK != null) || (this.movinegrPK != null && !this.movinegrPK.equals(other.movinegrPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "ClassesFirebird.Movinegr[ movinegrPK=" + movinegrPK + " ]";
    }
