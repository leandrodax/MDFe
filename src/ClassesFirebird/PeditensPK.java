 ...
 * @author vplayer
 */
public class PeditensPK implements Serializable {
    ...
    public PeditensPK(String nrpedido, int nritem) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PeditensPK)) {
            return false;
        }
        PeditensPK other = (PeditensPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.PeditensPK[ nrpedido=" + nrpedido + ", nritem=" + nritem + " ]";
    }
