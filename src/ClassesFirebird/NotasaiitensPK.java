...
public class NotasaiitensPK {
    
    private int nritem;
    private String nrcontr;

    public NotasaiitensPK() {
    }

    public NotasaiitensPK(int nritem, String nrcontr) {
        this.nritem = nritem;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NotasaiitensPK)) {
            return false;
        }
        NotasaiitensPK other = (NotasaiitensPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.NotasaiitensPK[ nritem=" + nritem + ", nrcontr=" + nrcontr + " ]";
    }
