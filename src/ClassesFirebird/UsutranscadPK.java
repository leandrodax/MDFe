...
public class UsutranscadPK implements Serializable {
    ...
    public UsutranscadPK() {
    }

    public UsutranscadPK(int codfil, Date dttransf, int codusu) {
        this.codfil = codfil;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UsutranscadPK)) {
            return false;
        }
        UsutranscadPK other = (UsutranscadPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.UsutranscadPK[ codfil=" + codfil + ", dttransf=" + dttransf + ", codusu=" + codusu + " ]";
    }
