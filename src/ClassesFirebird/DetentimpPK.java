 ...
 * @author vplayer
 */
public class DetentimpPK implements Serializable {
    private int keynfe;
    ...
    public DetentimpPK(int keynfe, int nitemdet, int nitem) {
        this.keynfe = keynfe;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetentimpPK)) {
            return false;
        }
        DetentimpPK other = (DetentimpPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.DetentimpPK[ keynfe=" + keynfe + ", nitemdet=" + nitemdet + ", nitem=" + nitem + " ]";
    }
