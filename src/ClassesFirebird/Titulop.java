...
public class Titulop implements Serializable {
    private static final long serialVersionUID = 1L;
    
    protected TitulopPK titulopPK;
    ...
    public Titulop(TitulopPK titulopPK) {
        this.titulopPK = titulopPK;
    }

    public Titulop(String codtit, int codfor) {
        this.titulopPK = new TitulopPK(codtit, codfor);
    }

    public TitulopPK getTitulopPK() {
        return titulopPK;
    }

    public void setTitulopPK(TitulopPK titulopPK) {
        this.titulopPK = titulopPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (titulopPK != null ? titulopPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Titulop)) {
            return false;
        }
        Titulop other = (Titulop) object;
        if ((this.titulopPK == null && other.titulopPK != null) || (this.titulopPK != null && !this.titulopPK.equals(other.titulopPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "ClassesFirebird.Titulop[ titulopPK=" + titulopPK + " ]";
    }
