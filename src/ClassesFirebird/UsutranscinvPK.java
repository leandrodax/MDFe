...
public class UsutranscinvPK implements Serializable {
    ...
    public UsutranscinvPK() {
    }

    public UsutranscinvPK(int codfil, Date dttransf, int codusu) {
        this.codfil = codfil;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UsutranscinvPK)) {
            return false;
        }
        UsutranscinvPK other = (UsutranscinvPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.UsutranscinvPK[ codfil=" + codfil + ", dttransf=" + dttransf + ", codusu=" + codusu + " ]";
    }
