 ...
 * @author vplayer
 */
public class ChequepPK implements Serializable {
    ...
    public ChequepPK(String banco, String agen, String conta, String numch) {
        this.banco = banco;
        this.agen = agen;
        this.conta = conta;
        this.numch = numch;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ChequepPK)) {
            return false;
        }
        ChequepPK other = (ChequepPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.ChequepPK[ banco=" + banco + ", agen=" + agen + ", conta=" + conta + ", numch=" + numch + " ]";
    }
