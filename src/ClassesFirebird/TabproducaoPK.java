...
public class TabproducaoPK implements Serializable {
    
    private String refpro;
    
    private String codpro;

    public TabproducaoPK() {
    }

    public TabproducaoPK(String refpro, String codpro) {
        this.refpro = refpro;
        this.codpro = codpro;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TabproducaoPK)) {
            return false;
        }
        TabproducaoPK other = (TabproducaoPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.TabproducaoPK[ refpro=" + refpro + ", codpro=" + codpro + " ]";
    }
