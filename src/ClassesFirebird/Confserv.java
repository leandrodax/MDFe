 ...
 * @author vplayer
 */
public class Confserv implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Confserv)) {
            return false;
        }
        Confserv other = (Confserv) object;
    ...
    public String toString() {
        return "ClassesFirebird.Confserv[ ordem=" + ordem + " ]";
    }
