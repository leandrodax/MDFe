...
public class Notapeditdel {
    
    private static final long serialVersionUID = 1L;
    protected NotapeditdelPK notapeditdelPK;
    ...
    private Double qtdexc;
    private Double totexc;
    private Notaped notaped;

    public Notapeditdel() {
    }

    public Notapeditdel(NotapeditdelPK notapeditdelPK) {
        this.notapeditdelPK = notapeditdelPK;
    }

    public Notapeditdel(int nritem, int nrped) {
        this.notapeditdelPK = new NotapeditdelPK(nritem, nrped);
    }

    public NotapeditdelPK getNotapeditdelPK() {
        return notapeditdelPK;
    }

    public void setNotapeditdelPK(NotapeditdelPK notapeditdelPK) {
        this.notapeditdelPK = notapeditdelPK;
    }
    ...
    public Double getQtdexc() {
        return qtdexc;
    }

    public void setQtdexc(Double qtdexc) {
        this.qtdexc = qtdexc;
    }

    public Double getTotexc() {
        return totexc;
    }

    public void setTotexc(Double totexc) {
        this.totexc = totexc;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (notapeditdelPK != null ? notapeditdelPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notapeditdel)) {
            return false;
        }
        Notapeditdel other = (Notapeditdel) object;
        if ((this.notapeditdelPK == null && other.notapeditdelPK != null) || (this.notapeditdelPK != null && !this.notapeditdelPK.equals(other.notapeditdelPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "ClassesFirebird.Notapeditdel[ notapeditdelPK=" + notapeditdelPK + " ]";
    }
