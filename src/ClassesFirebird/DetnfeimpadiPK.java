...
public class DetnfeimpadiPK implements Serializable {
    private int keynfe;
    private int nitemdet;
    private int nitemimp;
    private int nitem;

    public DetnfeimpadiPK() {
    }

    public DetnfeimpadiPK(int keynfe, int nitemdet, int nitemimp, int nitem) {
        this.keynfe = keynfe;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetnfeimpadiPK)) {
            return false;
        }
        DetnfeimpadiPK other = (DetnfeimpadiPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.DetnfeimpadiPK[ keynfe=" + keynfe + ", nitemdet=" + nitemdet + ", nitemimp=" + nitemimp + ", nitem=" + nitem + " ]";
    }
