...
public class UsutranscrecPK implements Serializable {
    ...
    public UsutranscrecPK() {
    }

    public UsutranscrecPK(int codfil, Date dttransf, int codusu) {
        this.codfil = codfil;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UsutranscrecPK)) {
            return false;
        }
        UsutranscrecPK other = (UsutranscrecPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.UsutranscrecPK[ codfil=" + codfil + ", dttransf=" + dttransf + ", codusu=" + codusu + " ]";
    }
