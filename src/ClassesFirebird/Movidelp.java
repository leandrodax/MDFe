...
public class Movidelp {
    ...
    public Movidelp(Integer nrcont) {
        this.nrcont = nrcont;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Movidelp)) {
            return false;
        }
        Movidelp other = (Movidelp) object;
    ...
    public String toString() {
        return "ClassesFirebird.Movidelp[ nrcont=" + nrcont + " ]";
    }
