...
public class UsutranstranPK implements Serializable {
    ...
    public UsutranstranPK() {
    }

    public UsutranstranPK(int codfil, Date dttransf, int codusu) {
        this.codfil = codfil;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UsutranstranPK)) {
            return false;
        }
        UsutranstranPK other = (UsutranstranPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.UsutranstranPK[ codfil=" + codfil + ", dttransf=" + dttransf + ", codusu=" + codusu + " ]";
    }
