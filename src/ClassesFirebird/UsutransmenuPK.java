...
public class UsutransmenuPK implements Serializable {
    ...
    public UsutransmenuPK() {
    }

    public UsutransmenuPK(int codfil, Date dttransf, int codusu) {
        this.codfil = codfil;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UsutransmenuPK)) {
            return false;
        }
        UsutransmenuPK other = (UsutransmenuPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.UsutransmenuPK[ codfil=" + codfil + ", dttransf=" + dttransf + ", codusu=" + codusu + " ]";
    }
