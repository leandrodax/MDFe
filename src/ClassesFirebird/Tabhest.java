 ...
 * @author vplayer
 */
public class Tabhest implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Tabhest)) {
            return false;
        }
        Tabhest other = (Tabhest) object;
    ...
    public String toString() {
        return "ClassesFirebird.Tabhest[ codhis=" + codhis + " ]";
    }
