...
public class UsutranscestPK implements Serializable {
    ...
    public UsutranscestPK() {
    }

    public UsutranscestPK(int codfil, Date dttransf, int codusu) {
        this.codfil = codfil;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UsutranscestPK)) {
            return false;
        }
        UsutranscestPK other = (UsutranscestPK) object;
    ...
    public String toString() {
        return "ClassesFirebird.UsutranscestPK[ codfil=" + codfil + ", dttransf=" + dttransf + ", codusu=" + codusu + " ]";
    }
