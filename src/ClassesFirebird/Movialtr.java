...
public class Movialtr {
    ...
    public Movialtr(Integer nrcont) {
        this.nrcont = nrcont;
    }
    ...
    public String getCodcliold() {
        return codcliold;
    }

    public void setCodcliold(String codcliold) {
        this.codcliold = codcliold;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Movialtr)) {
            return false;
        }
        Movialtr other = (Movialtr) object;
    ...
    public String toString() {
        return "ClassesFirebird.Movialtr[ nrcont=" + nrcont + " ]";
    }
