...
public class Moviincp {
    ...
    public Moviincp(Integer nrcont) {
        this.nrcont = nrcont;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Moviincp)) {
            return false;
        }
        Moviincp other = (Moviincp) object;
    ...
    public String toString() {
        return "ClassesFirebird.Moviincp[ nrcont=" + nrcont + " ]";
    }
