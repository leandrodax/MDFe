...
public class TelaBuscaEmbarcacao extends javax.swing.JDialog {

   
    public String sCOD = "",sCODEMB = "", sNOMEEMB = "", sTPEMB = "", sIRIN="";
  ...
  private void initComponents() {
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sCODEMB   = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sNOMEEMB  = jTablePrincipal.getValueAt(selecionada, 2).toString();
        sTPEMB    = jTablePrincipal.getValueAt(selecionada, 3).toString();
        sIRIN     = jTablePrincipal.getValueAt(selecionada, 4).toString();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaEmbarcacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaEmbarcacao().setVisible(true);
            }
        });
    }
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void DefinirFormulario() {
        ...
        for (int col = 0; col < jTablePrincipal.getColumnCount(); col++) {
            jTablePrincipal.getColumnModel().getColumn(col).setHeaderRenderer(new TelaBuscaEmbarcacao.MeuRenderizador());
        }
      ...
      //  esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTablePrincipal.getColumnModel().getColumn(1).setMinWidth(130);
        ...
        jTablePrincipal.getColumnModel().getColumn(3).setMaxWidth(250);
   ...
   public void CarregaTudo() {
    ...
    public void BuscaParametro(String desc) {
        try {
            ...
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_EMBARCACAO " + sql + " and RGEVENTO  <> '3' order by CODIGO");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
                    Conectar.result.getString("COD_EMB"),
