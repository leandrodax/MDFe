 ...
 * @author PC
 */
public class TelaBuscaConta extends javax.swing.JDialog {

    /**
     * Creates new form TelaBuscaConta
     */
    ...
    private void initComponents() {
        ...
        jFldBuscaConta = new javax.swing.JTextField();
        ...
        jFldBuscaConta.setDocument(new LimitaField(100, 0)
        );
        jFldBuscaConta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jFldBuscaContaActionPerformed(evt);
            }
        });
        jFldBuscaConta.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jFldBuscaContaKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jFldBuscaContaKeyReleased(evt);
            }
        });
        jPnlBusca.add(jFldBuscaConta);
        jFldBuscaConta.setBounds(20, 20, 390, 25);

        jTableConta.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        jTableConta.getTableHeader().setResizingAllowed(false);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPnlPrincipal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 695, Short.MAX_VALUE)
        );
    ...
    private void jFldBuscaContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFldBuscaContaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jFldBuscaContaActionPerformed

    private void jFldBuscaContaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldBuscaContaKeyReleased
        BuscaConta(jFldBuscaConta.getText());
    }//GEN-LAST:event_jFldBuscaContaKeyReleased

    private void jTableContaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableContaMouseClicked

        selecionada = jTableConta.getSelectedRow();
        if(evt.getClickCount() == 2){
            if(selecionada == -1){
                return;
            }
            iCOD = Integer.parseInt(jTableConta.getValueAt(selecionada, 0).toString());
            sDESC = jTableConta.getValueAt(selecionada, 1).toString();
            this.dispose();
        }
    ...
    private void jBtAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAnteriorActionPerformed
        ...
        if(jTableConta.getRowCount() > 0){
            ...
            if(selecionada != -1 && selecionada != 0){
                ...
                jTableConta.setRowSelectionInterval(selecionada -1, selecionada -1);
                //Seta a value da barra de rolagem para acompanhar a linha selecionada
                jScrollPane1.getVerticalScrollBar().setValue(jTableConta.getRowHeight() * jTableConta.getSelectedRow());
    ...
    private void jBtProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtProximoActionPerformed
        ...
        if(jTableConta.getRowCount() > 0){
            ...
            if(selecionada != -1 && selecionada != jTableConta.getRowCount() -1){
            ...
            }else if(selecionada == jTableConta.getRowCount() -1){
                //selecionada a ultima linha
                jTableConta.setRowSelectionInterval(jTableConta.getRowCount() -1, jTableConta.getRowCount() -1);
                jBtPrimeiro.setEnabled(true);
                jBtAnterior.setEnabled(true);
    ...
    private void jFldBuscaContaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldBuscaContaKeyPressed
    ...
    }//GEN-LAST:event_jFldBuscaContaKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaConta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaConta().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jFldBuscaConta;
    ...
    public void DefinirFormulario() {
        ...
        for (int col = 0; col < jTableConta.getColumnCount(); col++) {
            jTableConta.getColumnModel().getColumn(col).setHeaderRenderer(new MeuRenderizador());
        }
        
        centro.setHorizontalAlignment(SwingConstants.CENTER);
        direita.setHorizontalAlignment(SwingConstants.RIGHT);

        jTableConta.getColumnModel().getColumn(0).setMinWidth(60);
        jTableConta.getColumnModel().getColumn(0).setMaxWidth(60);
        jTableConta.getColumnModel().getColumn(0).setCellRenderer(centro);

        jTableConta.getColumnModel().getColumn(1).setMinWidth(100);
        jTableConta.getColumnModel().getColumn(1).setMaxWidth(100);
        jTableConta.getColumnModel().getColumn(1).setCellRenderer(esquerda);

        jTableConta.getColumnModel().getColumn(2).setMinWidth(70);
        jTableConta.getColumnModel().getColumn(2).setMaxWidth(70);
        jTableConta.getColumnModel().getColumn(2).setCellRenderer(esquerda);
        
        jTableConta.getColumnModel().getColumn(3).setMinWidth(70);
        jTableConta.getColumnModel().getColumn(3).setMaxWidth(70);
        jTableConta.getColumnModel().getColumn(3).setCellRenderer(esquerda);
        
        jTableConta.getColumnModel().getColumn(4).setMinWidth(70);
        jTableConta.getColumnModel().getColumn(4).setMaxWidth(70);
        jTableConta.getColumnModel().getColumn(4).setCellRenderer(esquerda);
        
        jTableConta.getColumnModel().getColumn(5).setMinWidth(70);
        jTableConta.getColumnModel().getColumn(5).setMaxWidth(70);
        jTableConta.getColumnModel().getColumn(5).setCellRenderer(esquerda);
    ...
    public void CarregaTudoConta() {
        try {
            LimpaTabela();
            Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTableConta.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from TABCONTA where RGEVENTO  <> '3'");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODCONTA"),
                    Conectar.result.getString("DESCCONTA"),
                    Conectar.result.getString("BANCO"),
                    Conectar.result.getString("AGENCIA"),
                    Conectar.result.getString("NRCONTA"),
                    Conectar.result.getString("CODFIL"),
                });
            }
    ...
    public void BuscaConta(String descconta) {
        try {
            sql = "";
            if (!"".equals(descconta)) {
                sql = "where DESCCONTA like '%" + descconta + "%'";
            } else if ("".equals(descconta)) {
                sql = "where DESCCONTA is not null";
            }

            LimpaTabela();
            //Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTableConta.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from TABCONTA " + sql + " and RGEVENTO  <> '3'");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODCONTA"),
                    Conectar.result.getString("DESCCONTA"),
