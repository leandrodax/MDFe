 ...
 * @author PC
 */
public class TelaBuscaAgNavegacao extends javax.swing.JDialog {

    public String sCODAG = "";
    public String sNOMEAG, sCNPJAG = "";
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sCODAG  = jTablePrincipal.getValueAt(selecionada, 0).toString();
        sNOMEAG = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sCNPJAG = jTablePrincipal.getValueAt(selecionada, 2).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaAgNavegacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaAgNavegacao().setVisible(true);
            }
        });
    }
    ...
    public void BuscaParametro(String desc) {
        try {
            if(desc.length() == 0){
                sql = "where COD_AGENCIA is not null";
            }else{
                sql = "where NOME like '" + desc + "%'";
            }
            ...
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_AGENCIA_NAVEG " + sql + " and RGEVENTO  <> '3' order by COD_AGENCIA");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("COD_AGENCIA"),
                    Conectar.result.getString("NOME"),
