 ...
 * @author PC
 */
public class TelaBuscaReboque extends javax.swing.JDialog {

    public String sCOD = "";
    public String sTP_CARROCERIA, sPLACA, sRNTRC, sTARA, sRENAVAM, sUF, sTP_RODADO, sCAPACIDADEKG, sCAPACIDADEM3, sCODPROP, sNOMPROP = "";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Informe o Código");
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Tipo de Carroceria", "Placa", "RNTRC", "Tara(KG)", "Renavam",
                "UF", "Tipo Rodado", "Capacidade (KG)", "Capacidade (M3)", "Tipo Proprietário", "Cód. Proprietário",
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 693, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 341, Short.MAX_VALUE)
        );
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sTP_CARROCERIA = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sPLACA         = jTablePrincipal.getValueAt(selecionada, 2).toString();
        sRNTRC         = jTablePrincipal.getValueAt(selecionada, 3).toString();
        sTARA          = jTablePrincipal.getValueAt(selecionada, 4).toString();
        sRENAVAM       = jTablePrincipal.getValueAt(selecionada, 5).toString();
        sUF            = jTablePrincipal.getValueAt(selecionada, 6).toString();
        sTP_RODADO     = jTablePrincipal.getValueAt(selecionada, 7).toString();
        sCAPACIDADEKG  = jTablePrincipal.getValueAt(selecionada, 8).toString();
        sCAPACIDADEM3  = jTablePrincipal.getValueAt(selecionada, 9).toString();
        if(jTablePrincipal.getValueAt(selecionada, 11) != null){
            sCODPROP       = jTablePrincipal.getValueAt(selecionada, 11).toString();
        }
        if(jTablePrincipal.getValueAt(selecionada, 12) != null){
            sNOMPROP       = jTablePrincipal.getValueAt(selecionada, 12).toString();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaReboque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaReboque().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
      ...
      //  esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTablePrincipal.getColumnModel().getColumn(2).setMinWidth(100);
        jTablePrincipal.getColumnModel().getColumn(2).setMaxWidth(100);
        ...
        jTablePrincipal.getColumnModel().getColumn(6).setMinWidth(50);
        jTablePrincipal.getColumnModel().getColumn(6).setMaxWidth(50);
        jTablePrincipal.getColumnModel().getColumn(6).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(8).setMinWidth(120);
        jTablePrincipal.getColumnModel().getColumn(8).setMaxWidth(120);
        jTablePrincipal.getColumnModel().getColumn(8).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(9).setMinWidth(120);
        jTablePrincipal.getColumnModel().getColumn(9).setMaxWidth(120);
        jTablePrincipal.getColumnModel().getColumn(9).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(10).setMinWidth(100);
        ...
        jTablePrincipal.getColumnModel().getColumn(11).setMinWidth(100);
        jTablePrincipal.getColumnModel().getColumn(11).setMaxWidth(100);
        ...
        jTablePrincipal.getColumnModel().getColumn(12).setMaxWidth(200);
    ...
    public void CarregaTudo() {
        try {
            ...
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_REBOQUE where RGEVENTO  <> '3' order by CODREBOQUE");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    ...
                    Conectar.result.getString("RNTC"),
                    util.TrocaPontoPorVirgula(Conectar.result.getFloat("TARA")) + " KG",
                    Conectar.result.getString("RENAVAM"),
                    Conectar.result.getString("ESTADO"),
                    TipoRodado(Conectar.result.getString("TP_RODADO")),
                    util.TrocaPontoPorVirgula(Conectar.result.getFloat("CAPACIDADE_KG")) + " KG",
                    util.TrocaPontoPorVirgula(Conectar.result.getFloat("CAPACIDADE_M3")) + " M3",
                    CalcTipoProprietario(Conectar.result.getString("PROPTERC")),
    ...
    public void BuscaParametro(String codigo) {
        try {
            if(codigo.length() == 0){
                sql = "where CODREBOQUE is not null";
            }else{
                sql = "where CODREBOQUE like '" + codigo + "%'";
            }
            ...
            //Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_REBOQUE " + sql + " and RGEVENTO  <> '3' order by CODREBOQUE");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODREBOQUE"),
                    TipoCarroceria(Conectar.result.getString("TP_CARROCERIA")),
