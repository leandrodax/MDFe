 ...
 * @author PC
 */
public class TelaBuscaResponsavelPagamento extends javax.swing.JDialog {

    public String sCODIGO = "";
    public String sNOME, sCNPJ, sCPF = "";
    ...
    public TelaBuscaResponsavelPagamento() {
        initComponents();
        DefinirFormulario();
        CarregaTudo();
        SairEsc();
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Fornecedor de Vale", "CPF", "CNPJ"
            }
        ){
            @Override
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaResponsavelPagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaResponsavelPagamento().setVisible(true);
            }
        });
    }
    ...
    public void BuscaParametro(String busca) {
        try {
            if(busca.length() == 0){
                ...
                sql = "where RESPONSAVEL like '" + busca + "%'";
            }
            ...
            Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_RESP_PAG_VALE " + sql + " and RGEVENTO  <> '3' order by CODIGO");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODIGO"),
                    Conectar.result.getString("RESPONSAVEL"),
