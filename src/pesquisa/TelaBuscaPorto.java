 ...
 * @author PC
 */
public class TelaBuscaPorto extends javax.swing.JDialog {

    public String sCODPRT = "";
    public String sNOMPRT, sIDPRT = "";
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Id. Porto", "Nome do Porto", "Cód. Usuário", "Usuário", "Data", "Evento"
            }
        ){
            @Override
        ...
        jScrollPane1.setBounds(10, 60, 670, 230);
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sCODPRT  = jTablePrincipal.getValueAt(selecionada, 0).toString();
        sIDPRT   = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sNOMPRT  = jTablePrincipal.getValueAt(selecionada, 2).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaPorto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaPorto().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
      ...
      //  esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTablePrincipal.getColumnModel().getColumn(2).setMinWidth(300);
   ...
   public void CarregaTudo() {
    ...
    public void BuscaParametro(String desc) {
        try {
            if(desc.length() == 0){
                sql = "where ID_PORTO is not null";
            }else{
                sql = "where NOME_PORTO like '" + desc + "%'";
            }
            ...
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_PORTO " + sql + " and RGEVENTO  <> '3' order by CODIGO");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
                    Conectar.result.getString("ID_PORTO"),
