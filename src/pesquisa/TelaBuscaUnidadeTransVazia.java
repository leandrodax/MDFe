 ...
 * @author PC
 */
public class TelaBuscaUnidadeTransVazia  extends javax.swing.JDialog {

    public static String sCOD= "", sID_TRANS= "", sTIPO = "";
    ...
    public TelaBuscaUnidadeTransVazia() {
        initComponents();
        DefinirFormulario();
        CarregaTudo();
        SairEsc();
  ...
  private void initComponents() {
    ...
    jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
      ...
      new String [] {
        "Código", "Identificação ", "Tipo de Unidade de Transporte Vazia"
      }
    ){
      @Override
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sID_TRANS = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sTIPO     = jTablePrincipal.getValueAt(selecionada, 2).toString();
        
        System.out.println("sCOD : "      + sCOD);     
        System.out.println("sID_CARGA : " + sID_TRANS);   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaUnidadeTransVazia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaUnidadeTransVazia().setVisible(true);
            }
        });
    }
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void BuscaParametro(String busca) {
        try {
            ...
            Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_UN_TRANS_VAZIA " + sql + " and RGEVENTO  <> '3' order by CODIGO");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODIGO"),
                    Conectar.result.getString("ID_UN_TRANS"),
