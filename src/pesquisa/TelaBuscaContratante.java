...
public class TelaBuscaContratante extends javax.swing.JDialog {

    public String sCODIGO = "";
    public String sNOME, sCPF, sCNPJ = "";
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 337, Short.MAX_VALUE)
        );
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sCODIGO  = (jTablePrincipal.getValueAt(selecionada, 0).toString());
        sNOME = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sCPF  = jTablePrincipal.getValueAt(selecionada, 2).toString();
        sCNPJ = jTablePrincipal.getValueAt(selecionada, 3).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaContratante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaContratante().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
      ...
      //  esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTablePrincipal.getColumnModel().getColumn(0).setCellRenderer(esquerda);

        //Adiciona as teclas de atalho  ALT + para os seguintes botões
        jBtOk.setMnemonic(java.awt.event.KeyEvent.VK_O);
        jBtCancelar.setMnemonic(java.awt.event.KeyEvent.VK_H);
        ...
        try {
            ...
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("COD_CONTRATANTE"),
    ...
    public void BuscaParametro(String desc) {
        try {
            if(desc.length() == 0){
                sql = "where COD_CONTRATANTE is not null";
            }else{
                sql = "where CONT_NOME like '" + desc + "%'";
            }
            ...
            Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_CONTRATANTE " + sql + " and RGEVENTO  <> '3' order by COD_CONTRATANTE");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("COD_CONTRATANTE"),
                    Conectar.result.getString("CONT_NOME"),
