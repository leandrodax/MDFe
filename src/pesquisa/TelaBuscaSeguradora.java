...
public class TelaBuscaSeguradora extends javax.swing.JDialog {

    public String sCOD_SEG = "";
    public String sNOME_SEG, sCNPJ_SEG = "";
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 60, 680, 230);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sCOD_SEG  = jTablePrincipal.getValueAt(selecionada, 0).toString();
        sNOME_SEG = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sCNPJ_SEG = jTablePrincipal.getValueAt(selecionada, 2).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaSeguradora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaSeguradora().setVisible(true);
            }
        });
    }
    ...
    public void BuscaParametro(String desc) {
        try {
            if(desc.length() == 0){
                sql = "where SEG_CODIGO is not null";
            }else{
                sql = "where SEG_NOME like '" + desc + "%'";
            }
            ...
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_SEGURADORA " + sql + " and RGEVENTO  <> '3' order by SEG_CODIGO");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("SEG_CODIGO"),
                    Conectar.result.getString("SEG_NOME"),
