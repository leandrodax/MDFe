 ...
 * @author PC
 */
public class TelaBuscaTerminalDescarregamento extends javax.swing.JDialog {

    public String sCOD, sCOD_TERMINAL, sNOME_TERMINAL = "";
    ...
    public TelaBuscaTerminalDescarregamento() {
        initComponents();
        DefinirFormulario();
        CarregaTudo();
        SairEsc();
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Cód. Terminal de Descarregamento", "Terminal de Descarregamento"
            }
        ){
            @Override
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 695, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sCOD_TERMINAL = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sNOME_TERMINAL = jTablePrincipal.getValueAt(selecionada, 2).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println(TelaBuscaTerminalCarregamento.class.getName());                                     
        } catch (ClassNotFoundException ex) {
            java.util.logging.Logger.getLogger(TelaBuscaTerminalDescarregamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaTerminalDescarregamento().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
      ...
      //  esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTablePrincipal.getColumnModel().getColumn(1).setMinWidth(215);
        jTablePrincipal.getColumnModel().getColumn(1).setMaxWidth(215);
    ...
    public void BuscaParametro(String busca) {
        try {
            if(busca.length() == 0){
                ...
                sql = "where NOM_TERM_DESCARREG like '" + busca + "%'";
            }
            ...
            Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_TERM_DESCARREG " + sql + " and RGEVENTO  <> '3' order by CODIGO");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODIGO"),
                    Conectar.result.getString("COD_TERM_DESCARREG"),
