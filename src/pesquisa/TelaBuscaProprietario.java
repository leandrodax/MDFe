...
public class TelaBuscaProprietario extends javax.swing.JDialog {
     ...
     */
    public String sCOD = "";
    public String sNOME, sRNTRC, sTIPO, sUF, sCPF, sCNPJ, sIE = "";
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome do Propietário", "RNTRC", "Código", "Tipo", "UF", "CPF", "CNPJ", "IE"
            }
        ){
            @Override
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sRNTRC = jTablePrincipal.getValueAt(selecionada, 2).toString();
        sTIPO = jTablePrincipal.getValueAt(selecionada, 4).toString();
        sUF = jTablePrincipal.getValueAt(selecionada, 5).toString();
        sCPF = jTablePrincipal.getValueAt(selecionada, 6).toString();
        sCNPJ = jTablePrincipal.getValueAt(selecionada, 7).toString();
        sIE = jTablePrincipal.getValueAt(selecionada, 8).toString();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaProprietario().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
      ...
      //  esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTablePrincipal.getColumnModel().getColumn(1).setMaxWidth(300);
        jTablePrincipal.getColumnModel().getColumn(1).setCellRenderer(esquerda);

        jTablePrincipal.getColumnModel().getColumn(2).setMinWidth(120);
        jTablePrincipal.getColumnModel().getColumn(2).setMaxWidth(120);
        jTablePrincipal.getColumnModel().getColumn(2).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(3).setMinWidth(70);
        jTablePrincipal.getColumnModel().getColumn(3).setMaxWidth(70);
        ...
        jTablePrincipal.getColumnModel().getColumn(5).setMinWidth(50);
        jTablePrincipal.getColumnModel().getColumn(5).setMaxWidth(50);
    ...
    public void BuscaParametro(String desc) {
        try {
            sql = "where PROP_NOME like '%" + desc + "%'";
            
            LimpaTabela();
            //Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_PROPRIETARIO " + sql + " and RGEVENTO  <> '3'");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("COD_PROPRIETARIO"),
                    Conectar.result.getString("PROP_NOME"),
                    ...
                    Conectar.result.getString("PROP_CNPJ"),
                    Conectar.result.getString("PROP_IE"),
                });
