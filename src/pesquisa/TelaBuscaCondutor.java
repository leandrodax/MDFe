 ...
 * @author PC
 */
public class TelaBuscaCondutor extends javax.swing.JDialog {

    public String sCOD = "";
    public String sNOME, sCPF = "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaCondutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaCondutor().setVisible(true);
            }
        });
    }
    ...
    public void BuscaParametro(String desc) {
        try {
            ...
            //Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from TABPROF " + sql + " and RGEVENTO  <> '3' order by CODPROF");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODPROF"),
                    Conectar.result.getString("NOMPROF"),
