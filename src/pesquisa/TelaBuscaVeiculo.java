...
public class TelaBuscaVeiculo extends javax.swing.JDialog {
    ...
    public String sCOD = "";
    public String sTP_CARROCERIA, sPLACA, sTARA, sRENAVAM, sUF, sTP_RODADO, sCAPACIDADEKG, sCAPACIDADEM3 = "",  sCODPROP, sNOMPROP, sPROPTERC;
    Integer selecionada;
    String sql, ordnar; 
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Tipo de Carroceria", "Placa", "Tara(KG)", "Renavam",
                "UF", "Tipo Rodado", "Capacidade (KG)", "Capacidade (M3)", "Codigo", "Proprietário", "Tipo Proprietário"
            }
        ){
            @Override
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 340, Short.MAX_VALUE)
        );
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sTARA          = jTablePrincipal.getValueAt(selecionada, 3).toString();
        sRENAVAM       = jTablePrincipal.getValueAt(selecionada, 4).toString();
        sUF            = jTablePrincipal.getValueAt(selecionada, 5).toString();
        sTP_RODADO     = jTablePrincipal.getValueAt(selecionada, 6).toString();
        sCAPACIDADEKG  = jTablePrincipal.getValueAt(selecionada, 7).toString();
        sCAPACIDADEM3  = jTablePrincipal.getValueAt(selecionada, 8).toString();
        sCODPROP       = (String) jTablePrincipal.getValueAt(selecionada, 9);
        sNOMPROP       = jTablePrincipal.getValueAt(selecionada, 10).toString();
        sPROPTERC      = jTablePrincipal.getValueAt(selecionada, 11).toString();
    ...
    public void DefinirFormulario(){
        ...
        jTablePrincipal.getTableHeader().setBackground(Color.blue);
        ...
        jTablePrincipal.getColumnModel().getColumn(1).setMinWidth(400);
        ...
        jTablePrincipal.getColumnModel().getColumn(2).setMinWidth(400);
        jTablePrincipal.getColumnModel().getColumn(2).setMaxWidth(700);
        jTablePrincipal.getColumnModel().getColumn(2).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(3).setMinWidth(400);
        jTablePrincipal.getColumnModel().getColumn(3).setMaxWidth(400);
        jTablePrincipal.getColumnModel().getColumn(3).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(4).setMinWidth(500);
        jTablePrincipal.getColumnModel().getColumn(4).setMaxWidth(600);
        ...
        jTablePrincipal.getColumnModel().getColumn(5).setMaxWidth(400);
        jTablePrincipal.getColumnModel().getColumn(5).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(6).setMinWidth(200);
        jTablePrincipal.getColumnModel().getColumn(6).setMaxWidth(300);
        ...
        jTablePrincipal.getColumnModel().getColumn(7).setMaxWidth(200);
        jTablePrincipal.getColumnModel().getColumn(7).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(8).setMinWidth(100);
        jTablePrincipal.getColumnModel().getColumn(8).setMaxWidth(200);
        jTablePrincipal.getColumnModel().getColumn(8).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(9).setMinWidth(100);
        jTablePrincipal.getColumnModel().getColumn(9).setMaxWidth(200);
        jTablePrincipal.getColumnModel().getColumn(9).setCellRenderer(esquerda);
        
        jTablePrincipal.getColumnModel().getColumn(10).setMinWidth(300);
        jTablePrincipal.getColumnModel().getColumn(10).setMaxWidth(500);
    ...
    public void CarregaTudo() {
        try {
            ...
            Conectar.result = Conectar.stam.executeQuery("select * from TABVEIC where RGEVENTO <> '3' order by CODVEIC ");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    ...
                    Conectar.result.getString("PROPTERC"),  });
            }
    ...
    public void BuscaPorParametro(String codveic) {
        try {
            sql = "";
            if (!"".equals(codveic)) {
                sql = "where CODVEIC like '%" + codveic + "%'";
            } else if ("".equals(codveic)) {
            ...
            Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from TABVEIC " + sql + " and RGEVENTO <> '3'");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODVEIC"),
                    TipoCarroceria(Conectar.result.getString("TP_CARROCERIA")),
