 ...
 * @author PC
 */
public class TelaBuscaFornecedorVale extends javax.swing.JDialog {

    public String sCOD = "";
    public String sNOME, sCNPJ = "";
    ...
    public TelaBuscaFornecedorVale() {
        initComponents();
        DefinirFormulario();
        CarregaTudo();
        SairEsc();
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Fornecedor de Vale", "CNPJ"
            }
        ){
            @Override
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 692, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sCNPJ = jTablePrincipal.getValueAt(selecionada, 2).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaFornecedorVale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaFornecedorVale().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
      ...
      //  esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTablePrincipal.getColumnModel().getColumn(1).setMaxWidth(400);
    ...
    public void BuscaParametro(String codigo) {
        try {
            if(codigo.length() == 0){
                sql = "where FORVALEPEDAGIO is not null";
            }else{
                sql = "where FORVALEPEDAGIO like '" + codigo + "%'";
            }
            ...
            //Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_FORVALEPEDAGIO " + sql + " and RGEVENTO  <> '3' order by CODFORVALE");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODFORVALE"),
                    Conectar.result.getString("FORVALEPEDAGIO"),
