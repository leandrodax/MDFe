 ...
 * @author PC
 */
public class TelaBuscaTerminalCarregamento extends javax.swing.JDialog {

    public String sCODIGO, sCOD_TERMINAL, sNOME_TERMINAL = "";
    ...
    public TelaBuscaTerminalCarregamento() {
        initComponents();
        DefinirFormulario();
        CarregaTudo();
        SairEsc();
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Cód. Terminal de Carregamento", "Terminal de Carregamento"
            }
        ){
            @Override
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaTerminalCarregamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaTerminalCarregamento().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
      ...
      //  esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTablePrincipal.getColumnModel().getColumn(2).setMinWidth(415);
        jTablePrincipal.getColumnModel().getColumn(2).setMaxWidth(415);
    ...
    public void BuscaParametro(String busca) {
        try {
            ...
            Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_TERM_CARREG " + sql + " and RGEVENTO  <> '3' order by CODIGO");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODIGO"),
                    Conectar.result.getString("COD_TERM_CARREG"),
