 ...
 * @author PC
 */
public class TelaBuscaBalsa extends javax.swing.JDialog {

    public String sCODBALSA,sIDBALSA = "";
    public String sNOMEBALSA;
    ...
    private void jBtOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtOkActionPerformed
        ...
        sCODBALSA  = jTablePrincipal.getValueAt(selecionada, 0).toString();
        sIDBALSA   = jTablePrincipal.getValueAt(selecionada, 1).toString();
        sNOMEBALSA = jTablePrincipal.getValueAt(selecionada, 2).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaBalsa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaBalsa().setVisible(true);
            }
        });
    }
   ...
   public void CarregaTudo() {
    ...
    public void BuscaParametro(String desc) {
        try {
            if(desc.length() == 0){
                sql = "where ID_BALSA is not null";
            }else{
                sql = "where NOME_BALSA like '" + desc + "%'";
            }
            ...
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_BALSA  " + sql + " and RGEVENTO  <> '3' order by CODIGO");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
                    Conectar.result.getString("ID_BALSA"),
