...
public class TelaAgenciaNavegacao extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome da Agência", "CNPJ", "Cód. Usuário", "Usuário", "Data", "Evento"
            }
        ){
            @Override
        ...
        jFldNomeAgNaveg.setDocument(new LimitaField(60, 0));
        ...
        jLabel18.setText("Nome da Agência");
        ...
        jLabel18.setBounds(10, 50, 100, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAgenciaNavegacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAgenciaNavegacao().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
        ...
        setTitle("Cadastro de Agência de Navegação");
    ...
    public void CarregaTudo() {
        try {
            Conectar.ConectarBD();
            LimpaTabela();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_AGENCIA_NAVEG WHERE RGEVENTO <> '3'");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("COD_AGENCIA"),
    ...
    /**
     * Método que busca os dados na tabela MDFE_CAD_AGENCIA_NAVEG para enviar
    ...
    public void CarregaCampoEdit(String codAgNaveg) {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_AGENCIA_NAVEG WHERE COD_AGENCIA = '" + codAgNaveg + "' ");
            while (Conectar.result.next()) {
                jFldCodAgNaveg.setText(Conectar.result.getString("COD_AGENCIA"));
                jFldNomeAgNaveg.setText(Conectar.result.getString("NOME"));
    ...
    public void BuscaParametro(String busca) {
        try {
            ...
            LimpaTabela();
            Conectar.ConectarBD();
            System.out.println("SELECT * FROM MDFE_CAD_AGENCIA_NAVEG " + sql + " AND RGEVENTO <> '3' ORDER BY " + ordnar + " ");
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_AGENCIA_NAVEG " + sql + " AND RGEVENTO <> '3' ORDER BY " + ordnar + " ");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("COD_AGENCIA"),
                    Conectar.result.getString("NOME"),
                    Conectar.result.getString("CNPJ"),
                    Conectar.result.getString("RGCODUSU"),
                    Conectar.result.getString("RGUSUARIO"),
                    Conectar.result.getDate("RGDATA"),
                    Conectar.result.getString("RGEVENTO")
     ...
     */
    public void Inserir(String codAgNaveg, String nomeAgNaveg, String CNPJ) {
        try {
            Conectar.ConectarBD();

            System.out.println("INSERT INTO MDFE_CAD_AGENCIA_NAVEG (COD_AGENCIA, NOME, CNPJ, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO )"
                    + " VALUES('" + codAgNaveg + "', '" + nomeAgNaveg + "', '" + CNPJ + "', " + tabusu.getCodigo() + ", '" + tabusu.getNome() + "', "
                    + " '" + util.FormataDataBanco(new Date()) + "', 1)"
            );

            Conectar.stam.executeUpdate("INSERT INTO MDFE_CAD_AGENCIA_NAVEG (COD_AGENCIA, NOME, CNPJ, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO )"
                    + " VALUES('" + codAgNaveg + "', '" + nomeAgNaveg + "', '" + CNPJ + "', " + tabusu.getCodigo() + ", '" + tabusu.getNome() + "', "
                    + " '" + util.FormataDataBanco(new Date()) + "', 1)"
            );
     ...
     * MDFE_CAD_AGENCIA_NAVEG.
     */
    public void Alterar(String codAgNaveg, String nomeAgNaveg, String CNPJ) {
        try {
            Conectar.ConectarBD();

            System.out.println("UPDATE MDFE_CAD_AGENCIA_NAVEG SET "
                    + "NOME      = '" + nomeAgNaveg + "', "
                    + "CNPJ      = '" + CNPJ + "', "
                    ...
                    + "RGEVENTO  = 2"
                    + "WHERE COD_AGENCIA = '" + codAgNaveg + "' "
            );

            Conectar.stam.executeUpdate("UPDATE MDFE_CAD_AGENCIA_NAVEG SET "
                    + "NOME      = '" + nomeAgNaveg + "', "
                    + "CNPJ      = '" + CNPJ + "', "
                    + "RGCODUSU  = " + tabusu.getCodigo() + ", "
                    + "RGUSUARIO = '" + tabusu.getNome() + "', "
     ...
     * MDFE_CAD_AGENCIA_NAVEG.
     */
    public void Deletar(String codAgNaveg) {
        try {
            Conectar.ConectarBD();
    ...
    public void BuscaCodMax() {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT MAX(COD_AGENCIA) + 1 FROM MDFE_CAD_AGENCIA_NAVEG ");
            while (Conectar.result.next()) {
