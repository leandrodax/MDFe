...
public class TelaUnidadeCargaVazia extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jCmbBxTpCarga = new javax.swing.JComboBox<>();
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Identificação da Un. de Carga", "Tipo", "Cód. Usuário", "Usuário", "Data", "Evento"
            }
        ){
            @Override
        ...
        jLabel18.setText("Tipo de Carga");
        ...
        jCmbBxTpCarga.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Container", "ULD", "Pallet", "Outros" }));
        jCmbBxTpCarga.setSelectedIndex(-1);
        jCmbBxTpCarga.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jCmbBxTpCargaKeyPressed(evt);
            }
        });
        jPnlNorte.add(jCmbBxTpCarga);
        jCmbBxTpCarga.setBounds(470, 70, 110, 25);

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel19.setText("Identificação da Carga");
        ...
        jLabel19.setBounds(10, 50, 180, 30);
    ...
    private void jBtGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtGravarActionPerformed
        if (tag_acao == "1" && VerificaField() == true) {
            Inserir(jFldCodigo.getText(), jFldIdentCarga.getText(), VerificaCodTipoCarga(jCmbBxTpCarga.getSelectedItem().toString()));
        }

        if (tag_acao == "2" && VerificaField() == true) {
            Alterar(jFldCodigo.getText(), jFldIdentCarga.getText(), VerificaCodTipoCarga(jCmbBxTpCarga.getSelectedItem().toString()));
        }
    ...
    private void jCmbBxTpCargaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCmbBxTpCargaKeyPressed
        if (evt.getKeyCode() == evt.VK_ENTER) {
            jBtGravar.requestFocus();
        }
    }//GEN-LAST:event_jCmbBxTpCargaKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaUnidadeCargaVazia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaUnidadeCargaVazia().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> jCmbBxTpCarga;
    ...
    public void DefinirFormulario() {
        ...
        setTitle("Cadastro de Unidades de Cargas Vazias");
    ...
    public void CarregaCampoEdit(String codigo) {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_UN_CARGA_VAZIA WHERE CODIGO = '" + codigo + "' ");
            while (Conectar.result.next()) {
                jFldCodigo.setText(Conectar.result.getString("CODIGO"));
                jFldIdentCarga.setText(Conectar.result.getString("ID_UN_CARGA"));
                jCmbBxTpCarga.setSelectedItem(VerificaTipoCarga(Conectar.result.getString("TP_UN_CARGA")));
            }
            Conectar.DesconectarBD();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void BuscaParametro(String busca) {
        try {
            ...
            LimpaTabela();
            Conectar.ConectarBD();
            System.out.println("SELECT * FROM MDFE_UN_CARGA_VAZIA " + sql + " AND RGEVENTO <> '3'  ORDER BY " + ordnar + " ");
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_UN_CARGA_VAZIA " + sql + " AND RGEVENTO <> '3'  ORDER BY " + ordnar + " ");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
    ...
    public void Inserir(String codigo, String idUnCarga, String tpUnCarga) {
        try {
            ...
            System.out.println("INSERT INTO MDFE_CAD_UN_CARGA_VAZIA (CODIGO, ID_UN_CARGA, TP_UN_CARGA, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO)"
                    + " VALUES('" + codigo + "', '" + idUnCarga + "', '" + tpUnCarga + "', "+ tabusu.getCodigo() +", '"+ tabusu.getNome() +"', "
                            + " '"+ util.FormataDataBanco(new Date()) +"', 1)"
            );

            Conectar.stam.executeUpdate("INSERT INTO MDFE_CAD_UN_CARGA_VAZIA (CODIGO, ID_UN_CARGA, TP_UN_CARGA, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO)"
                    + " VALUES('" + codigo + "', '" + idUnCarga + "', '" + tpUnCarga + "', "+ tabusu.getCodigo() +", '"+ tabusu.getNome() +"', "
                            + " '"+ util.FormataDataBanco(new Date()) +"', 1)"
            );
    ...
    public void Alterar(String codigo, String idUnCarga, String tpUnCarga) {
        try {
            ...
            System.out.println("UPDATE MDFE_CAD_UN_CARGA_VAZIA SET "
            ...
            Conectar.stam.executeUpdate("UPDATE MDFE_CAD_UN_CARGA_VAZIA SET "
                    + "ID_UN_CARGA = '" + idUnCarga + "', "
                    + "TP_UN_CARGA = '" + tpUnCarga + "', "
                    + "RGCODUSU    = "+ tabusu.getCodigo() +", "
                    + "RGUSUARIO   = '"+ tabusu.getNome() +"', "
    ...
    public void BuscaCodMax() {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT MAX(CODIGO) + 1 FROM MDFE_CAD_UN_CARGA_VAZIA ");
            while (Conectar.result.next()) {
    ...
    public String VerificaCodTipoCarga(String desc){
        String tipo = "";
        if(desc.equals("Container")){
            tipo = "1";
        }else if(desc.equals("ULD")){
            tipo = "2";
        }else if(desc.equals("Pallet")){
            tipo = "3";
        }else if(desc.equals("Outros")){
            tipo = "4";
        }
    ...
    */
    public boolean VerificaField() {
        if (jFldIdentCarga.getText().length() == 0) {
            JOptionPane.showMessageDialog(null, "Identificação da Carga não preenchido!");
            jFldIdentCarga.requestFocus();
            return false;
        } else if (jCmbBxTpCarga.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Selecione o tipo da carga.");
            jCmbBxTpCarga.requestFocus();
            return false;
        }else{
            return true;
