...
public class TelaBalsa extends javax.swing.JInternalFrame {
  ...
  private void initComponents() {
    ...
    jFldCodBalsa = new javax.swing.JTextField();
    jFldNomeBalsa = new javax.swing.JTextField();
    ...
    jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
      ...
      new String [] {
        "Código", "Código de Indentificação", "Nome da Balsa", "Cód. Usuário", "Usuário", "Data", "Evento"
      }
    ){
      @Override
    ...
    jLabel17.setText("Código de identificação da Balsa");
    ...
    jFldCodBalsa.setDocument(new LimitaField(5, 2)
    );
    jFldCodBalsa.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusGained(java.awt.event.FocusEvent evt) {
        jFldCodBalsaFocusGained(evt);
      }
      public void focusLost(java.awt.event.FocusEvent evt) {
        jFldCodBalsaFocusLost(evt);
      }
    });
    jFldCodBalsa.addKeyListener(new java.awt.event.KeyAdapter() {
      public void keyPressed(java.awt.event.KeyEvent evt) {
        jFldCodBalsaKeyPressed(evt);
      }
      public void keyTyped(java.awt.event.KeyEvent evt) {
        jFldCodBalsaKeyTyped(evt);
      }
    });
    jPnlNorte.add(jFldCodBalsa);
    jFldCodBalsa.setBounds(10, 80, 250, 25);

    jFldNomeBalsa.setDocument(new LimitaField(60, 0));
    jFldNomeBalsa.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        jFldNomeBalsaActionPerformed(evt);
      }
    });
    jFldNomeBalsa.addKeyListener(new java.awt.event.KeyAdapter() {
      public void keyPressed(java.awt.event.KeyEvent evt) {
        jFldNomeBalsaKeyPressed(evt);
      }
      public void keyReleased(java.awt.event.KeyEvent evt) {
        jFldNomeBalsaKeyReleased(evt);
      }
      public void keyTyped(java.awt.event.KeyEvent evt) {
        jFldNomeBalsaKeyTyped(evt);
      }
    });
    jPnlNorte.add(jFldNomeBalsa);
    jFldNomeBalsa.setBounds(10, 130, 570, 25);

    jLabel18.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
    jLabel18.setText("Nome da Balsa");
    ...
    private void jFldNomeBalsaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFldNomeBalsaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jFldNomeBalsaActionPerformed

    private void jFldNomeBalsaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldNomeBalsaKeyPressed
      
        
        if (evt.getKeyCode() == evt.VK_ENTER) {
            jBtGravar.requestFocus();
        }
    }//GEN-LAST:event_jFldNomeBalsaKeyPressed

    private void jFldNomeBalsaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldNomeBalsaKeyReleased

    }//GEN-LAST:event_jFldNomeBalsaKeyReleased

    private void jFldNomeBalsaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldNomeBalsaKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_jFldNomeBalsaKeyTyped
    ...
    private void jFldCodBalsaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldCodBalsaKeyTyped
        String Caracteres = "0123456789";
        if (!Caracteres.contains(evt.getKeyChar() + "")) {
            evt.consume();
        }
    }//GEN-LAST:event_jFldCodBalsaKeyTyped

    private void jFldCodBalsaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFldCodBalsaFocusLost
        
    }//GEN-LAST:event_jFldCodBalsaFocusLost

    private void jFldCodBalsaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldCodBalsaKeyPressed
         if (evt.getKeyCode() == evt.VK_ENTER) {
            jFldNomeBalsa.requestFocus();
        }        
    }//GEN-LAST:event_jFldCodBalsaKeyPressed

    private void jFldCodBalsaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFldCodBalsaFocusGained
        jFldCodBalsa.setText(jFldCodBalsa.getText().replaceAll("[/.]", "").replaceAll("-", ""));
    }//GEN-LAST:event_jFldCodBalsaFocusGained
    ...
    private void jBtGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtGravarActionPerformed
        if (tag_acao == "1" && VerificaField() == true) {
            Inserir(jFldCodSeq.getText(), jFldCodBalsa.getText().replaceAll("[/-]", "").replaceAll("\\.", ""), jFldNomeBalsa.getText());
        }

        if (tag_acao == "2" && VerificaField() == true) {
            Alterar(jFldCodSeq.getText(), jFldCodBalsa.getText().replaceAll("[/-]", "").replaceAll("\\.", "") , jFldNomeBalsa.getText());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBalsa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
  ...
  private javax.swing.JTextField jFldCodBalsa;
  private javax.swing.JTextField jFldCodSeq;
  private javax.swing.JTextField jFldNomeBalsa;
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void CarregaTudo() {
        try {
            Conectar.ConectarBD();
            LimpaTabela();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_BALSA WHERE RGEVENTO <> '3'");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
                    Conectar.result.getString("ID_BALSA"),
                    Conectar.result.getString("NOME_BALSA"),
    ...
    /**
     * Método que busca os dados na tabela MDFE_CAD_BALSA para enviar
    ...
    public void CarregaCampoEdit(String CODIGO) {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_BALSA WHERE CODIGO = '" + CODIGO + "'");
            while (Conectar.result.next()) {
                jFldCodSeq.setText(Conectar.result.getString("CODIGO"));
                jFldCodBalsa.setText(Conectar.result.getString("ID_BALSA"));
                jFldNomeBalsa.setText(Conectar.result.getString("NOME_BALSA"));
        ...
        try {
            ...
            if(busca.length() > 0){
                if (jCmbBxBusca.getSelectedItem().equals("Código")) {
                    sql = "WHERE ID_BALSA = '" + busca + "' ";
                } else if (jCmbBxBusca.getSelectedItem().equals("Nome")) {
                    sql = "WHERE NOME_BALSA like '" + busca + "%' ";
                }
            }else{
            ...
            LimpaTabela();
            Conectar.ConectarBD();
            System.out.println("SELECT * FROM MDFE_CAD_BALSA " + sql + " AND RGEVENTO <> '3' ORDER BY " + ordnar + " ");
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_BALSA " + sql + " AND RGEVENTO <> '3' ORDER BY " + ordnar + " ");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
     ...
     * MDFE_CAD_BALSA.
     */
    public void Inserir(String CODIGO, String ID_BALSA, String NOME_BALSA) {
        try {
            Conectar.ConectarBD();

            System.out.println("INSERT INTO MDFE_CAD_BALSA (CODIGO, ID_BALSA, NOME_BALSA, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO )"
                    + " VALUES('" + CODIGO + "', '" + ID_BALSA + "', '" + NOME_BALSA + "', " + tabusu.getCodigo() + ", '" + tabusu.getNome() + "', "
                    + " '" + util.FormataDataBanco(new Date()) + "', 1)"
            );

            Conectar.stam.executeUpdate("INSERT INTO MDFE_CAD_BALSA (CODIGO, ID_BALSA, NOME_BALSA, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO )"
                    + " VALUES('" + CODIGO + "', '" + ID_BALSA + "', '" + NOME_BALSA + "', " + tabusu.getCodigo() + ", '" + tabusu.getNome() + "', "
                    + " '" + util.FormataDataBanco(new Date()) + "', 1)"
            );
     ...
     * MDFE_CAD_BALSA.
     */
    public void Alterar(String CODIGO, String ID_BALSA, String NOME_BALSA) {
        try {
            Conectar.ConectarBD();

            System.out.println("UPDATE MDFE_CAD_BALSA SET "
                   
                    + "ID_BALSA      = '" + ID_BALSA + "', "
                    + "NOME_BALSA    = '" + NOME_BALSA + "', "                            
            ...
            Conectar.stam.executeUpdate("UPDATE MDFE_CAD_BALSA SET "
    ...
    public void BuscaCodMax() {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT MAX(CODIGO) + 1 FROM MDFE_CAD_BALSA ");
            while (Conectar.result.next()) {
    ...
    public boolean VerificaField() {
        if (jFldNomeBalsa.getText().length() == 0) {
            JOptionPane.showMessageDialog(null, "Nome da Balsa não preechido");
            jFldNomeBalsa.requestFocus();
            return false;
        } else if (jFldCodBalsa.getText().length() == 0) {
            JOptionPane.showMessageDialog(null, "Código  da Balsa não preenchido");
            jFldCodBalsa.requestFocus();
            return false;
        } else {
            return true;
    ...
    public void LimpaField() {
        jFldCodSeq.setText("");
        jFldNomeBalsa.setText("");
        jFldCodBalsa.setText("");
    }
