...
public class TelaUnidadeTransVazia extends javax.swing.JInternalFrame {
  ...
  private void initComponents() {
    ...
    jCmbBxPesquisa = new javax.swing.JComboBox<>();
    ...
    jFldIdentCarga = new javax.swing.JTextField();
    jCmbBxTpTransporte = new javax.swing.JComboBox<>();
    jLabel19 = new javax.swing.JLabel();
    jPnlEditBotao = new javax.swing.JPanel();
    ...
    jCmbBxOrdem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código", "Identificação", "Tipo" }));
    ...
    jFldBusca.setDocument(new LimitaField(100, 1)
    );
    ...
    jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
      ...
      new String [] {
        "Código", "Identificação da Un. Transporte vazio", "Tipo de Transporte vazio", "Cód. Usuário", "Usuário", "Data", "Evento"
      }
    ){
      @Override
    ...
    jCmbBxPesquisa.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
    jCmbBxPesquisa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código", "Identificação" }));
    jCmbBxPesquisa.addItemListener(new java.awt.event.ItemListener() {
      public void itemStateChanged(java.awt.event.ItemEvent evt) {
        jCmbBxPesquisaItemStateChanged(evt);
      }
    });
    jCmbBxPesquisa.addKeyListener(new java.awt.event.KeyAdapter() {
      public void keyPressed(java.awt.event.KeyEvent evt) {
        jCmbBxPesquisaKeyPressed(evt);
      }
    });
    ...
    jPnlBuscaLayout.setHorizontalGroup(
      ...
      .addGroup(jPnlBuscaLayout.createSequentialGroup()
        ...
        .addGroup(jPnlBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addGroup(jPnlBuscaLayout.createSequentialGroup()
            .addGroup(jPnlBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
              .addComponent(jFldBusca, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE)
              .addComponent(jLblPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGap(20, 20, 20)
            .addGroup(jPnlBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
              .addComponent(jCmbBxPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
              .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGap(20, 20, 20)
            .addGroup(jPnlBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
              .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
              .addComponent(jCmbBxOrdem, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    jPnlBuscaLayout.setVerticalGroup(
      ...
      .addGroup(jPnlBuscaLayout.createSequentialGroup()
        .addGap(10, 10, 10)
        .addGroup(jPnlBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addComponent(jLblPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
          ...
          .addGroup(jPnlBuscaLayout.createSequentialGroup()
            ...
            .addGroup(jPnlBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
              ...
              .addComponent(jCmbBxPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    jPnlNorte.setPreferredSize(new java.awt.Dimension(594, 350));
    ...
    jLabel18.setText("Tipo de Transporte");
    ...
    jLabel18.setBounds(470, 50, 110, 30);

    jFldIdentCarga.setDocument(new LimitaField(20, 1));
    jFldIdentCarga.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        jFldIdentCargaActionPerformed(evt);
      }
    });
    jFldIdentCarga.addKeyListener(new java.awt.event.KeyAdapter() {
      public void keyTyped(java.awt.event.KeyEvent evt) {
        jFldIdentCargaKeyTyped(evt);
      }
      public void keyPressed(java.awt.event.KeyEvent evt) {
        jFldIdentCargaKeyPressed(evt);
      }
      public void keyReleased(java.awt.event.KeyEvent evt) {
        jFldIdentCargaKeyReleased(evt);
      }
    });
    jPnlNorte.add(jFldIdentCarga);
    jFldIdentCarga.setBounds(10, 70, 440, 25);

    jCmbBxTpTransporte.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Caminhão", "Carreta" }));
    jCmbBxTpTransporte.setSelectedIndex(-1);
    jCmbBxTpTransporte.addKeyListener(new java.awt.event.KeyAdapter() {
      public void keyPressed(java.awt.event.KeyEvent evt) {
        jCmbBxTpTransporteKeyPressed(evt);
      }
    });
    jPnlNorte.add(jCmbBxTpTransporte);
    jCmbBxTpTransporte.setBounds(470, 70, 110, 25);

    jLabel19.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
    jLabel19.setText("Identificação do Transporte de Carga Vazia");
    ...
    jLabel19.setBounds(10, 57, 300, 13);

    jPnlEdit.add(jPnlNorte, java.awt.BorderLayout.NORTH);

    jPnlEditBotao.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
    jPnlEditBotao.setPreferredSize(new java.awt.Dimension(0, 60));
    ...
    javax.swing.GroupLayout jPnlEditBotaoLayout = new javax.swing.GroupLayout(jPnlEditBotao);
    jPnlEditBotao.setLayout(jPnlEditBotaoLayout);
    jPnlEditBotaoLayout.setHorizontalGroup(
      jPnlEditBotaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGroup(jPnlEditBotaoLayout.createSequentialGroup()
        .addGap(8, 8, 8)
        .addComponent(jBtGravar, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addGap(130, 130, 130)
        .addComponent(jLblAcao, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
        .addGap(140, 140, 140)
        .addComponent(jBtCancelar, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addContainerGap())
    );
    jPnlEditBotaoLayout.setVerticalGroup(
      jPnlEditBotaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGroup(jPnlEditBotaoLayout.createSequentialGroup()
        .addGap(8, 8, 8)
        .addGroup(jPnlEditBotaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addComponent(jBtGravar, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
          .addGroup(jPnlEditBotaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    jPnlEdit.add(jPnlEditBotao, java.awt.BorderLayout.SOUTH);
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        ...
        if (selecionada != -1 && jTablePrincipal.getRowCount() > 0) {
            ...
            JOptionPane.showMessageDialog(null, "Nenhuma unidade de carga selecionada");
        }
        //  }else{
        //    JOptionPane.showMessageDialog(null, "Usuário não habilitado para este tipo de operação!");
        //}
    ...
    private void jBtGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtGravarActionPerformed
        if (tag_acao == "1" && VerificaField() == true) {
            Inserir(jFldCodigo.getText(), jFldIdentCarga.getText(), VerificaCodTipoCarga(jCmbBxTpTransporte.getSelectedItem().toString()));
        }

        if (tag_acao == "2" && VerificaField() == true) {
            Alterar(jFldCodigo.getText(), jFldIdentCarga.getText(), VerificaCodTipoCarga(jCmbBxTpTransporte.getSelectedItem().toString()));
        }
    ...
    private void jFldIdentCargaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFldIdentCargaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jFldIdentCargaActionPerformed

    private void jFldIdentCargaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldIdentCargaKeyPressed
        if (evt.getKeyCode() == evt.VK_ENTER) {
            jCmbBxTpTransporte.requestFocus();
        }
    }//GEN-LAST:event_jFldIdentCargaKeyPressed

    private void jFldIdentCargaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldIdentCargaKeyReleased

    }//GEN-LAST:event_jFldIdentCargaKeyReleased

    private void jFldIdentCargaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFldIdentCargaKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_jFldIdentCargaKeyTyped
    ...
    private void jCmbBxTpTransporteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCmbBxTpTransporteKeyPressed
        if (evt.getKeyCode() == evt.VK_ENTER) {
            jBtGravar.requestFocus();
        }
    }//GEN-LAST:event_jCmbBxTpTransporteKeyPressed

    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        // TODO add your handling code here:
    }//GEN-LAST:event_formInternalFrameClosed

    private void jCmbBxPesquisaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCmbBxPesquisaItemStateChanged
        jLblPesquisa.setText(jCmbBxPesquisa.getSelectedItem().toString() + ":");
        BuscaParametro(jFldBusca.getText());
    }//GEN-LAST:event_jCmbBxPesquisaItemStateChanged

    private void jCmbBxPesquisaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCmbBxPesquisaKeyPressed
        if (evt.getKeyCode() == evt.VK_ENTER) {
            jCmbBxOrdem.requestFocus();
        }
    }//GEN-LAST:event_jCmbBxPesquisaKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaUnidadeTransVazia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaUnidadeTransVazia().setVisible(true);
            }
        });
    }
  ...
  private javax.swing.JComboBox<String> jCmbBxPesquisa;
  private javax.swing.JComboBox<String> jCmbBxTpTransporte;
  private javax.swing.JTextField jFldBusca;
  private javax.swing.JTextField jFldCodigo;
  private javax.swing.JTextField jFldIdentCarga;
  ...
  private javax.swing.JPanel jPnlEditBotao;
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void DefinirFormulario() {
        ...
        setTitle("Cadastro de Unidades de Transporte Vazias");
        ...
        jTablePrincipal.getColumnModel().getColumn(1).setMinWidth(250);
        jTablePrincipal.getColumnModel().getColumn(1).setMaxWidth(250);
    ...
    public void CarregaTudo() {
        try {
            Conectar.ConectarBD();
            LimpaTabela();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_UN_TRANS_VAZIA WHERE RGEVENTO <> '3' ");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
    ...
    /**
     * Método que busca os dados na tabela MDFE_UN_CARGA_VAZIA para enviar para
     * os campos do jPnlEdit a partir do codigo.
     *
     * @param codigo O código da agência de navegação;
     */
    public void CarregaCampoEdit(String codigo) {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_UN_TRANS_VAZIA WHERE CODIGO = '" + codigo + "' ");
            while (Conectar.result.next()) {
                jFldCodigo.setText(Conectar.result.getString("CODIGO"));
                jFldIdentCarga.setText(Conectar.result.getString("ID_UN_TRANS"));
                jCmbBxTpTransporte.setSelectedItem(VerificaTipoCarga(Conectar.result.getString("TIPO")));
            }
            Conectar.DesconectarBD();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void BuscaParametro(String busca) {
        try {
            ...
            sql = "";
            if(jCmbBxPesquisa.getSelectedItem().equals("Código")){
                sql = "WHERE (CODIGO like '"+ busca +"%' )";
            }else if(jCmbBxPesquisa.getSelectedItem().equals("Identificação")){
                sql = "WHERE (ID_UN_TRANS like '"+ busca +"%')";
            }
            

            if (jCmbBxOrdem.getSelectedItem().equals("Código")) {
                ordnar = "CODIGO";
            } else if (jCmbBxOrdem.getSelectedItem().equals("Identificação")) {
                ordnar = "ID_UN_TRANS";
            } else if(jCmbBxOrdem.getSelectedItem().equals("Tipo")){
                ordnar = "TIPO";
            }

            LimpaTabela();
            Conectar.ConectarBD();
            System.out.println("SELECT * FROM MDFE_CAD_UN_TRANS_VAZIA " + sql + " AND RGEVENTO <> '3'  ORDER BY " + ordnar + " ");
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_UN_TRANS_VAZIA " + sql + " AND RGEVENTO <> '3'  ORDER BY " + ordnar + " ");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
     ...
     * MDFE_UN_CARGA_VAZIA.
     */
    public void Inserir(String codigo, String idUnCarga, String tpUnCarga) {
        try {
            Conectar.ConectarBD();

            System.out.println("INSERT INTO MDFE_CAD_UN_TRANS_VAZIA (CODIGO, ID_UN_TRANS, TIPO, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO)"
                    + " VALUES('" + codigo + "', '" + idUnCarga + "', '" + tpUnCarga + "', "+ tabusu.getCodigo() +", '"+ tabusu.getNome() +"', "
                            + " '"+ util.FormataDataBanco(new Date()) +"', 1)"
            );

            Conectar.stam.executeUpdate("INSERT INTO MDFE_CAD_UN_TRANS_VAZIA (CODIGO, ID_UN_TRANS, TIPO, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO)"
                    + " VALUES('" + codigo + "', '" + idUnCarga + "', '" + tpUnCarga + "', "+ tabusu.getCodigo() +", '"+ tabusu.getNome() +"', "
                            + " '"+ util.FormataDataBanco(new Date()) +"', 1)"
            );
     ...
     * MDFE_UN_CARGA_VAZIA.
     */
    public void Alterar(String codigo, String idUnCarga, String tpUnCarga) {
        try {
            Conectar.ConectarBD();

            System.out.println("UPDATE MDFE_CAD_UN_TRANS_VAZIA SET "
                    + "ID_UN_TRANS = '" + idUnCarga + "', "
                    + "TIPO        = '" + tpUnCarga + "', "
            ...
            Conectar.stam.executeUpdate("UPDATE MDFE_CAD_UN_TRANS_VAZIA SET "
                    + "ID_UN_TRANS = '" + idUnCarga + "', "
                    + "TIPO        = '" + tpUnCarga + "', "
                    + "RGCODUSU    = "+ tabusu.getCodigo() +", "
                    + "RGUSUARIO   = '"+ tabusu.getNome() +"', "
    ...
    public void BuscaCodMax() {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT MAX(CODIGO) + 1 FROM MDFE_CAD_UN_TRANS_VAZIA ");
            while (Conectar.result.next()) {
    ...
    public String VerificaCodTipoCarga(String desc){
        String tipo = "";
    ...
    */
    public boolean VerificaField() {
        if (jFldIdentCarga.getText().length() == 0) {
            JOptionPane.showMessageDialog(null, "Identificação da Unidade de Transposte não preenchido!");
            jFldIdentCarga.requestFocus();
            return false;
        } else if (jCmbBxTpTransporte.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Selecione o tipo da Unidade de Transporte.");
            jCmbBxTpTransporte.requestFocus();
            return false;
        }else{
            return true;
