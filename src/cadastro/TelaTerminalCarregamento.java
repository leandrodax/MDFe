...
public class TelaTerminalCarregamento extends javax.swing.JInternalFrame {
    ...
    public TelaTerminalCarregamento() {
        initComponents();
        DefinirFormulario();
        CarregaTudo();
        SairEsc();
    ...
    private void initComponents() {
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Cód. Terminal", "Nome do Terminal de Carregamento", "Cód. Usuário", "Usuário", "Data", "Evento"
            }
        ){
            @Override
        ...
        jPnlNorte.setPreferredSize(new java.awt.Dimension(575, 200));
        ...
        jLabel18.setBounds(130, 50, 110, 30);
        ...
        jFldNomeTerminal.setBounds(130, 70, 440, 25);
        ...
        jLabel19.setBounds(10, 50, 120, 30);
        ...
        jPnlSulLayout.setHorizontalGroup(
            ...
            .addGroup(jPnlSulLayout.createSequentialGroup()
                ...
                .addGap(135, 135, 135)
                .addComponent(jLblAcao, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
                .addGap(147, 147, 147)
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        ...
        if (selecionada != -1 && jTablePrincipal.getRowCount() > 0) {
            ...
            JOptionPane.showMessageDialog(null, "Nenhum terminal de carregamento selecionado");
        }
        //  }else{
        //    JOptionPane.showMessageDialog(null, "Usuário não habilitado para este tipo de operação!");
        //}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTerminalCarregamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaTerminalCarregamento().setVisible(true);
            }
        });
    }
    ...
    public void DefinirFormulario() {
        ...
        setResizable(true);
        //Define o tamano minimo tomado pelo jFrame
        setMinimumSize(new Dimension(600, 450));
        //Define o tamanho do jFrame
        setSize(600, 450);
        //Define o título do jFrame
        setTitle("Cadastro de Terminal de Carregamento");
    ...
    public void CarregaTudo() {
        try {
            Conectar.ConectarBD();
            LimpaTabela();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_TERM_CARREG WHERE RGEVENTO <> '3'");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
                    Conectar.result.getString("COD_TERM_CARREG"),
                    Conectar.result.getString("NOM_TERM_CARREG"),
    ...
    /**
     * Método que busca os dados na tabela MDFE_CAD_EMBARCACAO para enviar para
    ...
    public void CarregaCampoEdit(String codigo) {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_TERM_CARREG WHERE CODIGO = '" + codigo + "' ");
            while (Conectar.result.next()) {
                jFldCodigo.setText(Conectar.result.getString("CODIGO"));
                jFldCodTerminal.setText(Conectar.result.getString("COD_TERM_CARREG"));
                jFldNomeTerminal.setText(Conectar.result.getString("NOM_TERM_CARREG"));
            }
            Conectar.DesconectarBD();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void BuscaParametro(String busca) {
        try {
            ...
            if(jCmbBxBusca.getSelectedItem().equals("Código")){
                ...
                sql = "WHERE NOM_TERM_CARREG like = '"+ busca +"%' ";
            }else{
                sql = "WHERE COD_TERM_CARREG like = '"+ busca +"%' ";
            }

            if (jCmbBxOrdem.getSelectedItem().equals("Código")) {
                ordnar = "CODIGO";
            } else if (jCmbBxOrdem.getSelectedItem().equals("Nome")) {
                ordnar = "NOM_TERM_CARREG";
            }

            LimpaTabela();
            Conectar.ConectarBD();
            System.out.println("SELECT * FROM MDFE_CAD_TERM_CARREG " + sql + " AND RGEVENTO <> '3' ORDER BY " + ordnar + " ");
            Conectar.result = Conectar.stam.executeQuery("SELECT * FROM MDFE_CAD_TERM_CARREG " + sql + " AND RGEVENTO <> '3' ORDER BY " + ordnar + " ");
            DefaultTableModel dtm = (DefaultTableModel) jTablePrincipal.getModel();
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getString("CODIGO"),
     ...
     * MDFE_CAD_TERM_CARREG.
     */
    public void Inserir(String codigo, String codTerm, String nomeTerm) {
        try {
            Conectar.ConectarBD();

            System.out.println("INSERT INTO MDFE_CAD_TERM_CARREG (CODIGO, COD_TERM_CARREG, NOM_TERM_CARREG,"
            ...
            Conectar.stam.executeUpdate("INSERT INTO MDFE_CAD_TERM_CARREG (CODIGO, COD_TERM_CARREG, NOM_TERM_CARREG,"
                    + "  RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO)"
                    + " VALUES('" + codigo + "', '" + codTerm + "', '" + nomeTerm + "', "+ tabusu.getCodigo() +", '"+ tabusu.getNome() +"', "
                            + " '"+ util.FormataDataBanco(new Date()) +"', 1 )"
            );
    ...
    public void Alterar(String codigo, String codTerm, String nomeTerm) {
        try {
            ...
            System.out.println("UPDATE MDFE_CAD_TERM_CARREG SET "
                    + "COD_TERM_CARREG = '" + codTerm + "', "
                    + "NOM_TERM_CARREG = '" + nomeTerm + "', "
            ...
            Conectar.stam.executeUpdate("UPDATE MDFE_CAD_TERM_CARREG SET "
                    + "COD_TERM_CARREG = '" + codTerm + "', "
                    + "NOM_TERM_CARREG = '" + nomeTerm + "', "
                    + "RGCODUSU        = "+ tabusu.getCodigo() +", "
                    + "RGUSUARIO       = '"+ tabusu.getNome() +"', "
    ...
    public void BuscaCodMax() {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("SELECT MAX(CODIGO) + 1 FROM MDFE_CAD_TERM_CARREG ");
            while (Conectar.result.next()) {
