 ...
 * @author Israel
 */
public class TelaForVale extends javax.swing.JInternalFrame {
    ...
    public TelaForVale() throws SQLException, InstantiationException, IllegalAccessException {
        initComponents();
        DefinirFormulario();
        CarregaTudo();       
        SairEsc();
    ...
    private void initComponents() {
        ...
        jPnlButao = new javax.swing.JPanel();
        ...
        setMaximizable(true);
        setTitle("Cadastro de Fornecedor de Vale");
        setToolTipText("");
        ...
        jTablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Fornecedor de Vale", "CNPJ", "Endereço", "Fone", "Cód. Usuário", "Usuário", "Data", "Evento"
            }
        ){
            @Override
    ...
    jPnlButao.setPreferredSize(new java.awt.Dimension(0, 50));
    jPnlButao.setLayout(new java.awt.GridLayout(1, 0));
    ...
    jPnlBuscaLayout.setHorizontalGroup(
        ...
        .addGroup(jPnlBuscaLayout.createSequentialGroup()
            ...
            .addGroup(jPnlBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addComponent(jPnlButao, javax.swing.GroupLayout.DEFAULT_SIZE, 574, Short.MAX_VALUE))
            .addGap(20, 20, 20))
    );
    jPnlBuscaLayout.setVerticalGroup(
        ...
        .addGroup(jPnlBuscaLayout.createSequentialGroup()
            ...
            .addGap(5, 5, 5)
            .addComponent(jPnlButao, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addContainerGap())
    );
    ...
    jPnlEdtNorte.setPreferredSize(new java.awt.Dimension(600, 350));
    jPnlEdtNorte.addKeyListener(new java.awt.event.KeyAdapter() {
        public void keyPressed(java.awt.event.KeyEvent evt) {
            jPnlEdtNorteKeyPressed(evt);
        }
    });
    ...
    jLabel4.setText("Fornecedor de Vale");
    ...
    javax.swing.GroupLayout jPnlEdtNorteLayout = new javax.swing.GroupLayout(jPnlEdtNorte);
    jPnlEdtNorte.setLayout(jPnlEdtNorteLayout);
    jPnlEdtNorteLayout.setHorizontalGroup(
        jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
            .addContainerGap()
            .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jFldNomeForVale)
                .addComponent(jFldEndereco)
                .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
                    .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
                            .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jFldCNPJ, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel13))
                            .addGap(18, 18, 18)
                            .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jFldFone, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
                ...
                .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jFldCodForVale, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(504, Short.MAX_VALUE)))
    );
    jPnlEdtNorteLayout.setVerticalGroup(
        jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPnlEdtNorteLayout.createSequentialGroup()
            .addGap(67, 67, 67)
            .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
                    .addGap(22, 22, 22)
                    .addComponent(jFldNomeForVale, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
                    .addGap(20, 20, 20)
                    .addComponent(jFldEndereco, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
            .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
                    .addGap(15, 15, 15)
            ...
            .addGap(2, 2, 2)
            .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(jFldCNPJ, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addComponent(jFldFone, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
                ...
                .addGroup(jPnlEdtNorteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPnlEdtNorteLayout.createSequentialGroup()
                        .addGap(22, 22, 22)
                        .addComponent(jFldCodForVale, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    jPnlEdtSulLayout.setHorizontalGroup(
        ...
        .addGroup(jPnlEdtSulLayout.createSequentialGroup()
            ...
            .addGap(127, 127, 127)
            .addComponent(jLabelAcao, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
            .addGap(130, 130, 130)
    ...
    private void jBtGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtGravarActionPerformed
        ...
        if ((tag_acao == "1") && (VerificaField() == true)) {
            ...
            try {               
                ...
                Inserir(Integer.parseInt(jFldCodForVale.getText()), jFldNomeForVale.getText().toUpperCase(), util.ExtraiNumeros(jFldCNPJ.getText()), jFldEndereco.getText().toUpperCase(),
        ...
        if ((tag_acao == "2") && (VerificaField() == true)) {
            try {              
                //     
                Alterar(Integer.parseInt(jFldCodForVale.getText()), jFldNomeForVale.getText().toUpperCase(), util.ExtraiNumeros(jFldCNPJ.getText()), jFldEndereco.getText().toUpperCase(),
        ...
        if ((tag_acao == "3") && (VerificaField() == true)) {
            try {
                ...
                Logger.getLogger(TelaForVale.class.getName()).log(Level.SEVERE, null, ex);
...
//        if(util.VerificarPermissao("01.24.03", tabusu.getCodigo()) == true){
    ...
    private void jPnlEdtNorteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPnlEdtNorteKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jPnlEdtNorteKeyPressed
 ...
 /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TelaForVale().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaForVale.class.getName()).log(Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    Logger.getLogger(TelaForVale.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JPanel jPnlButao;
    ...
    public void CarregaTudo() {
        try {
            ...
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_FORVALEPEDAGIO where rgevento <> '3'");
            while (Conectar.result.next()) {
                dtm.addRow(new Object[]{
                    Conectar.result.getInt("CODFORVALE"),
                    Conectar.result.getString("FORVALEPEDAGIO"),
                    ...
                    Conectar.result.getString("RGDATA"),
    ...
    public void BuscaCodigoMaximo() throws SQLException, InstantiationException, IllegalAccessException {
        try {
            Conectar.ConectarBD();
            Conectar.result = Conectar.stam.executeQuery("select max (CODFORVALE) + 1 from MDFE_CAD_FORVALEPEDAGIO ");
            while (Conectar.result.next()) {
        ...
        try {
            ...
            if (jComboBoxPesquisa.getSelectedItem().equals("Código")) {
                if (FldPesquisa.getText().equals("")) {
                    ...
                    sql = " AND CODFORVALE = " + FldPesquisa.getText();
                }
                ...
                if (FldPesquisa.getText().equals("")) {
                    ...
                    sql = " AND FORVALEPEDAGIO LIKE '" + FldPesquisa.getText() + "%'";
                }
            ...
            if (jComboBoxOrdem.getSelectedItem().equals("Ordem")) {
                ...
                ordnar = "FORVALEPEDAGIO";
            }

            System.out.println("select * from MDFE_CAD_FORVALEPEDAGIO where (rgevento <> '3' ) " + sql + "   order by " + ordnar);
            limpatabelaVeiculo();
            Conectar.ConectarBD();
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTablePrincipal.getModel();
            Conectar.result = Conectar.stam.executeQuery("select * from MDFE_CAD_FORVALEPEDAGIO where (rgevento <> '3' ) " + sql + " order by " + ordnar);
            while (Conectar.result.next()) {
    ...
    public void DefinirFormulario() {
        ...
        for (int col = 0; col < jTablePrincipal.getColumnCount(); col++) {
            jTablePrincipal.getColumnModel().getColumn(col).setHeaderRenderer(new TelaForVale.MeuRenderizador());
        }
        ...
        jTablePrincipal.getColumnModel().getColumn(4).setMaxWidth(150);
        ...
        jTablePrincipal.getColumnModel().getColumn(6).setMaxWidth(350);
        jTablePrincipal.getColumnModel().getColumn(6).setMinWidth(300);
    ...
    public void CarregaCampoEdit(String CODIGO) {
        try {
            ...
            while (Conectar.result.next()) {
                jFldCodForVale.setText(Conectar.result.getString("CODFORVALE"));
                jFldNomeForVale.setText(Conectar.result.getString("FORVALEPEDAGIO"));
    ...
    public void Inserir(Integer CODFORVALE, String FORVALEPEDAGIO, String CNPJ, String ENDERECO, String FONE,
        ...
        System.out.println("insert into MDFE_CAD_FORVALEPEDAGIO "
                + " (CODFORVALE, FORVALEPEDAGIO, CNPJ, ENDERECO, FONE, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO)"
                + " values(" + CODFORVALE + ", '" + FORVALEPEDAGIO + "', '" + CNPJ + "','" + ENDERECO + "','" + FONE 
                + "', " + RGCODUSU + ",'" + RGUSUARIO + "','" + RGDATA + "','" + RGEVENTO + "')");

        Conectar.stam.executeUpdate("insert into MDFE_CAD_FORVALEPEDAGIO "
                + " (CODFORVALE, FORVALEPEDAGIO, CNPJ, ENDERECO, FONE, RGCODUSU, RGUSUARIO, RGDATA, RGEVENTO)"
                + " values(" + CODFORVALE + ", '" + FORVALEPEDAGIO + "', '" + CNPJ + "','" + ENDERECO + "','" + FONE 
                + "', " + RGCODUSU + ",'" + RGUSUARIO + "','" + RGDATA + "','" + RGEVENTO + "')");
    ...
    public void Alterar(Integer CODFORVALE, String FORVALEPEDAGIO, String CNPJ, String ENDERECO, String FONE,
            Integer RGCODUSU, String RGUSUARIO, String RGDATA, String RGEVENTO)
            throws SQLException, InstantiationException, IllegalAccessException {
        try {

            Conectar.ConectarBD();
            System.out.println("update  MDFE_CAD_FORVALEPEDAGIO set "
                    + " FORVALEPEDAGIO  = '" + FORVALEPEDAGIO + "',"
                    + " CNPJ       = '" + CNPJ + "',"
                    + " ENDERECO   = '" + ENDERECO + "',"
                    + " FONE       = '" + FONE + "',"
                    + " RGCODUSU   =  " + RGCODUSU + ","
                    ...
                    + " RGDATA     = '" + RGDATA + "',"
                    + " RGEVENTO   = '" + RGEVENTO + "'"
                    + " where CODFORVALE = " + CODFORVALE);

            Conectar.stam.executeUpdate("update  MDFE_CAD_FORVALEPEDAGIO set "
                    + " FORVALEPEDAGIO  = '" + FORVALEPEDAGIO + "',"
                    + " CNPJ       = '" + CNPJ + "',"
                    + " ENDERECO   = '" + ENDERECO + "',"
                    + " FONE       = '" + FONE + "',"
    ...
    public void Deletar(Integer CODFORVALE, Integer RGCODUSU, String RGUSUARIO, String RGDATA, String RGEVENTO)
            throws SQLException, InstantiationException, IllegalAccessException {
        try {
            Conectar.ConectarBD();
            System.out.println("update MDFE_CAD_FORVALEPEDAGIO set "
